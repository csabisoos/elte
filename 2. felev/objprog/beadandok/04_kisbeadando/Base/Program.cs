        ...
        static void Main(string[] args)
        {
            ...
            switch (input[0])
            {
                case "Hozzáad":
                    ...
                    Element toAdd1 = new Element(pr1, input[1]);
                    toAdd1.pr = pr1;
                    toAdd1.data = input[1];
                    testQ.Add(toAdd1);
                ...
                case "Kiürítés":
                    ...
                    Element toAdd2 = new Element(pr2, input[1]);
                    toAdd2.pr = pr2;
                    toAdd2.data = input[1];
                    testQ.Add(toAdd2);
                    Console.WriteLine("A sor nem üres:");
                ...
                case "Maximumkiválasztás":
                    ...
                    Element toAdd3 = new Element(pr3, input[1]);
                    toAdd3.pr = pr3;
                    toAdd3.data = input[1];
                    Console.WriteLine("Prioritás Adat bemenet:");
                    input = Console.ReadLine()?.Split();
                    pr3 = int.Parse(input[0]);
                    Element toAdd4 = new Element(pr3, input[1]);
                    toAdd4.pr = pr3;
                    toAdd4.data = input[1];
                    Console.WriteLine("Prioritás Adat bemenet:");
                    input = Console.ReadLine()?.Split();
                    pr3 = int.Parse(input[0]);
                    Element toAdd5 = new Element(pr3, input[1]);
                    toAdd5.pr = pr3;
                    toAdd5.data = input[1];
                    testQ.Add(toAdd3);
                    testQ.Add(toAdd4);
